...
if (empty($fullname) || empty($email) || empty($campus)) {
	header("Location: http://capsicumcooking.com/lp-port-elizabeth-general-enquiry");
die();
}
...
$mysqli->query("INSERT INTO "
 ...
 '" . $page_url ."'
	...
	$to = $admin_email; 
	$email_subject = "Port Elizabeth Landing Page submission: $fullname";
...
header("Location: http://capsicumcooking.com/lp-port-elizabeth-general-enquiry/thank-you.html");
